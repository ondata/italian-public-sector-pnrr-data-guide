...
![Gli step del monitoraggio civico (da [Monithon](https://www.monithon.eu/crea-un-report-di-monitoraggio-civico/))](images/Percorso-Crea-Report.png){fig-alt="Gli step per la creazione di un report di monitoraggio" #fig-monitoraggio-step}
