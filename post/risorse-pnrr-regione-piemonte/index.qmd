...
➡️ È di recentissima pubblicazione nel portale nazionale il dataset denominato "[Progetti PNRR gestiti dalla Regione Piemonte - dettagli](https://dati.gov.it/view-dataset/dataset?id=5506399a-c01b-4bc5-a3ec-ed25a90539d9)".
...
🧮[Questi i dati](regpie-Coordfondi_pnrr_opendata_23951-focus-open_cup.csv) estraibili dal [Focus PNRR di OpenCUP](../../fonti/opencup/focus-pnrr.qmd).
