...
Al momento c'è un errore nei campi con gli importi: è presente il separatore delle migliaia. Va rimosso, altrimenti la gran parte dei programmi e dei linguaggi di scripting li interpreteranno quei valori come stringhe di testo e non come numeri (ad esempio `489.353,90` è da modificare in `489353,90`).
