...
Il [dataset CUP](../fonti/anac/index.qmd#il-dataset-cup) pubblicato dall'Autorità Nazionale Anticorruzione è composto da **più di 3 milioni di record**, quindi con un foglio elettronico è pressoché impossibile estrarre tutti i codici `CIG` corrispondenti ai codici `CUP` estratti sopra per Messina.<br>
