...
::: {.callout-warning}
## Questa non è la mappa del PNRR
...
La fonte di questi dati è [**ReGiS**](index.qmd), il sistema di rendicontazione e controllo delle misure e dei progetti finanziati dal Piano Nazionale di Ripresa e Resilienza.
:::

::: aside
Grazie [Ciro Spataro](https://twitter.com/cirospat), per averci suggerito di inserire questa nota.
:::
