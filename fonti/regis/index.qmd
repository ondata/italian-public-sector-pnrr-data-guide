...
Le [altre fonti](../fonti.qmd) non sono da considerarsi ormai superate e/o inutili, ma anzi, possono essere usate per arricchire le informazioni contenute in ReGIS, in quanto contengono alcune informazioni integrative.

Essenziali per le correlazioni i **Codici Unici di Progetto** (`CUP`) e i **Codici Identificativi Gara** (`CIG`).
