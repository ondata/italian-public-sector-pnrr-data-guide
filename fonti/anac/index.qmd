...
tabella_cup_cig=df.head(3).style.hide(axis='index')

display(tabella_cup_cig)
```
...
Alcuni informazioni su questo dataset:
...
[[⛏️ Come fare ]{.btn .btn-primary}](../../guide/procedura-generale.qmd)
