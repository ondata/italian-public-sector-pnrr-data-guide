...
Per leggere l'id di una tabella è sufficiente leggere la parte finale dell'URL (vedi @fig-id-tabella), o fare click sul pulsante `Data API` nella pagina del dataset e leggerlo.
