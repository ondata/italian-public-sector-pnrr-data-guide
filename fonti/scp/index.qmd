...
!if [ ! -f ../../data/spc/summary_v_od_atti.csv ]; then\
 mlrgo --csv summary ../../data/spc/v_od_atti.csv >../../data/spc/summary_v_od_atti.csv;\
fi

numero_record=!mlr --c2n cut -f count then head -n 1 ../../data/spc/summary_v_od_atti.csv
numero_cup=!mlr --c2n  filter '$field_name=="cup"' then cut -f distinct_count ../../data/spc/summary_v_od_atti.csv
numero_cig=!mlr --c2n  filter '$field_name=="cig"' then cut -f distinct_count ../../data/spc/summary_v_od_atti.csv
numero_id_gara=!mlr --c2n  filter '$field_name=="id_gara"' then cut -f distinct_count ../../data/spc/summary_v_od_atti.csv
numero_colonne=!echo "$(<../../data/spc/summary_v_od_atti.csv wc -l)-1" | bc

text=f"""

Alcuni informazioni correlate:
...
{{< include ../../include/_spc-transposed.md >}}

## I link ai documenti correlati

Un elemento di grande interesse, presente in questa banca dati è quella presente nella colonna `url_documento`, con l'URL della pagina web dove è possibile trovare documenti correlati all'atto in questione.

Si porta come [esempio](https://ingate.invitalia.it/esop/toolkit/opportunity/ns/7382/detail.si?isOnModification=false&_ncp=1675594340926.18822-2) quello dell'`id_gara` `1412023` e `CIG` [`918052266A`](https://dati.anticorruzione.it/superset/dettaglio_cig/918052266A).

[![Esempio di pagina con elenco documenti del bando](images/spc-link-documenti.png){#fig-scp-link-documento fig-alt="Esempio di link a documento"}](https://ingate.invitalia.it/esop/toolkit/opportunity/ns/7382/detail.si?isOnModification=false&_ncp=1675594340926.18822-2)
...
Si può fare almeno in **due modalità**, ma **entrambe non sono per tutte/i** e richiedono un po' di esperienza nell'accesso ai dati, la loro gestione e la loro trasformazione.
